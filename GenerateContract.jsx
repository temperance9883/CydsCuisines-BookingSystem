  ...
  const generatePDF = () => {
    ...
    const serviceText = [
      ...
      `Attendees: The Caterer agrees to provide Services for an estimated count of ${
        numberofguests || "N/A"} individuals for the Event. If this number increases, the total fee will be adjusted accordingly.`,
    ];
...
if (yPosition + 20 > pageHeight - margin) {
  ...
  doc.text("Client Signature: ________________________  Date: ______________", margin, yPosition);
  yPosition += 15;
  doc.text("Caterer Signature: ______________________  Date: ______________", margin, yPosition);
