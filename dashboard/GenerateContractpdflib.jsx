...
export default function GenerateContract({ bid, customerName }) {
  ...
  const generatePDF = async () => {
    ...
    // Footer
    const footer = `Signed by: ${customerName} (Client) - ${eventDate}`;
    ...
    link.href = url;
    link.download = `${customerName}_Catering_Contract.pdf`;
    link.click();
  };
        ...
        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <p className="text-lg text-gray-700 mb-6">
              ...
              <span className="font-semibold text-blue-500">{customerName}</span>.
            </p>
            <button
